/**
 * PZ Marketing Automator Module – Versão 2.0.0 – 2025-09-17
 *
 * - Implementação com Axios para comunicação direta com a API do ConvertKit.
 * - Remove a dependência do pacote instável 'convertkit' para maior estabilidade.
 */
